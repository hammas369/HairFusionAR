...
//sampler sampler LitLookupSmpSC 2:19
//sampler sampler Tweak_N0SmpSC 2:20
//sampler sampler Tweak_N147SmpSC 2:21
//sampler sampler Tweak_N180SmpSC 2:22
...
//sampler sampler sc_StrandDataMapTextureSmpSC 2:30
//texture texture2D LitLookup 2:0:2:19
//texture texture2D Tweak_N0 2:1:2:20
//texture texture2D Tweak_N147 2:2:2:21
//texture texture2D Tweak_N180 2:3:2:22
...
//texture texture2D sc_StrandDataMapTexture 2:18:2:30
//SG_REFLECTION_END
...
uniform vec4 Tweak_N147Dims;
uniform vec4 Tweak_N180Dims;
...
uniform float Tweak_N13;
uniform vec4 Tweak_N147Size;
uniform vec4 Tweak_N147View;
uniform mat3 Tweak_N147Transform;
uniform vec4 Tweak_N147UvMinMax;
uniform vec4 Tweak_N147BorderColor;
uniform vec4 Tweak_N180Size;
uniform vec4 Tweak_N180View;
uniform mat3 Tweak_N180Transform;
uniform vec4 Tweak_N180UvMinMax;
uniform vec4 Tweak_N180BorderColor;
uniform vec4 Tweak_N18;
uniform float Tweak_N14;
uniform float Tweak_N10;
uniform vec4 Port_Import_N171;
uniform float Port_Input1_N277;
...
uniform float Port_Import_N271;
uniform float Port_Import_N274;
uniform vec3 Port_Import_N243;
uniform vec2 Port_Value_N116;
uniform vec4 Port_Import_N242;
uniform vec2 Port_Input1_N085;
uniform vec2 Port_Input1_N121;
uniform vec2 Port_Import_N126;
uniform float Port_Import_N244;
uniform float Port_Import_N128;
uniform float Port_Import_N245;
uniform float Port_Import_N143;
uniform vec2 Port_Import_N270;
uniform float Port_Import_N157;
uniform float Port_Import_N159;
uniform vec3 Port_Import_N161;
uniform float Port_Import_N272;
...
#endif
#ifndef Tweak_N147HasSwappedViews
#define Tweak_N147HasSwappedViews 0
#elif Tweak_N147HasSwappedViews==1
#undef Tweak_N147HasSwappedViews
#define Tweak_N147HasSwappedViews 1
#endif
#ifndef Tweak_N147Layout
#define Tweak_N147Layout 0
#endif
#ifndef Tweak_N180HasSwappedViews
#define Tweak_N180HasSwappedViews 0
#elif Tweak_N180HasSwappedViews==1
#undef Tweak_N180HasSwappedViews
#define Tweak_N180HasSwappedViews 1
#endif
#ifndef Tweak_N180Layout
#define Tweak_N180Layout 0
#endif
...
#endif
#ifndef SC_USE_UV_TRANSFORM_Tweak_N180
#define SC_USE_UV_TRANSFORM_Tweak_N180 0
#elif SC_USE_UV_TRANSFORM_Tweak_N180==1
#undef SC_USE_UV_TRANSFORM_Tweak_N180
#define SC_USE_UV_TRANSFORM_Tweak_N180 1
#endif
#ifndef SC_SOFTWARE_WRAP_MODE_U_Tweak_N180
#define SC_SOFTWARE_WRAP_MODE_U_Tweak_N180 -1
#endif
#ifndef SC_SOFTWARE_WRAP_MODE_V_Tweak_N180
#define SC_SOFTWARE_WRAP_MODE_V_Tweak_N180 -1
#endif
#ifndef SC_USE_UV_MIN_MAX_Tweak_N180
#define SC_USE_UV_MIN_MAX_Tweak_N180 0
#elif SC_USE_UV_MIN_MAX_Tweak_N180==1
#undef SC_USE_UV_MIN_MAX_Tweak_N180
#define SC_USE_UV_MIN_MAX_Tweak_N180 1
#endif
#ifndef SC_USE_CLAMP_TO_BORDER_Tweak_N180
#define SC_USE_CLAMP_TO_BORDER_Tweak_N180 0
#elif SC_USE_CLAMP_TO_BORDER_Tweak_N180==1
#undef SC_USE_CLAMP_TO_BORDER_Tweak_N180
#define SC_USE_CLAMP_TO_BORDER_Tweak_N180 1
#endif
#ifndef SC_USE_UV_TRANSFORM_Tweak_N147
#define SC_USE_UV_TRANSFORM_Tweak_N147 0
#elif SC_USE_UV_TRANSFORM_Tweak_N147==1
#undef SC_USE_UV_TRANSFORM_Tweak_N147
#define SC_USE_UV_TRANSFORM_Tweak_N147 1
#endif
#ifndef SC_SOFTWARE_WRAP_MODE_U_Tweak_N147
#define SC_SOFTWARE_WRAP_MODE_U_Tweak_N147 -1
#endif
#ifndef SC_SOFTWARE_WRAP_MODE_V_Tweak_N147
#define SC_SOFTWARE_WRAP_MODE_V_Tweak_N147 -1
#endif
#ifndef SC_USE_UV_MIN_MAX_Tweak_N147
#define SC_USE_UV_MIN_MAX_Tweak_N147 0
#elif SC_USE_UV_MIN_MAX_Tweak_N147==1
#undef SC_USE_UV_MIN_MAX_Tweak_N147
#define SC_USE_UV_MIN_MAX_Tweak_N147 1
#endif
#ifndef SC_USE_CLAMP_TO_BORDER_Tweak_N147
#define SC_USE_CLAMP_TO_BORDER_Tweak_N147 0
#elif SC_USE_CLAMP_TO_BORDER_Tweak_N147==1
#undef SC_USE_CLAMP_TO_BORDER_Tweak_N147
#define SC_USE_CLAMP_TO_BORDER_Tweak_N147 1
#endif
#ifndef sc_DepthOnly
...
uniform sampler2D Tweak_N180;
uniform sampler2D Tweak_N147;
...
void Node278_If_else(float Bool1,vec4 Value1,vec4 Default,out vec4 Result,ssGlobals Globals)
{
Bool1=float(varDebugColor.w>Port_Input1_N277);
if ((Bool1*1.0)!=0.0)
{
...
{
float l9_0=Globals.Surface_UVCoord0.y-(1.0-Tweak_N152);
vec2 l9_1=vec2(Globals.Surface_UVCoord0.x,l9_0);
int l9_2;
...
if ((float(l9_0<Port_Input1_N030)*1.0)!=0.0)
{
discard;
}
vec3 l9_4=l9_3.xyz;
float l9_5=Tweak_N16*Port_Input1_N057;
vec3 l9_6=mix(mix(Tweak_N6.xyz,l9_4*Tweak_N6.xyz,vec3(Tweak_N6.w)),mix(Tweak_N5.xyz,l9_4*Tweak_N5.xyz,vec3(Tweak_N5.w)),vec3(smoothstep(Tweak_N15-l9_5,Tweak_N15+l9_5,Globals.Surface_UVCoord0.y)));
float l9_7=cos(Tweak_N20);
float l9_8=sin(Tweak_N20);
int l9_9;
...
#endif
vec4 l9_10=sc_SampleTextureBiasOrLevel(LitLookupDims.xy,LitLookupLayout,l9_9,vec2((Globals.VertexTangent_ViewSpace.y*l9_7)-(Globals.VertexTangent_ViewSpace.x*l9_8),((Globals.VertexTangent_ViewSpace.y*l9_8)+(Globals.VertexTangent_ViewSpace.x*l9_7))+Tweak_N19),(int(SC_USE_UV_TRANSFORM_LitLookup)!=0),LitLookupTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_LitLookup,SC_SOFTWARE_WRAP_MODE_V_LitLookup),(int(SC_USE_UV_MIN_MAX_LitLookup)!=0),LitLookupUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_LitLookup)!=0),LitLookupBorderColor,0.0,LitLookup);
int l9_11;
#if (Tweak_N180HasSwappedViews)
{
...
#endif
vec4 l9_12=sc_SampleTextureBiasOrLevel(Tweak_N180Dims.xy,Tweak_N180Layout,l9_11,l9_1,(int(SC_USE_UV_TRANSFORM_Tweak_N180)!=0),Tweak_N180Transform,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N180,SC_SOFTWARE_WRAP_MODE_V_Tweak_N180),(int(SC_USE_UV_MIN_MAX_Tweak_N180)!=0),Tweak_N180UvMinMax,(int(SC_USE_CLAMP_TO_BORDER_Tweak_N180)!=0),Tweak_N180BorderColor,0.0,Tweak_N180);
vec2 l9_13=((Globals.VertexTangent_ViewSpace.xy+((Port_Value_N116+vec2(0.001))-vec2(0.001)))-((l9_12.xy*Port_Input1_N085)-vec2(1.0)))*Port_Input1_N121;
float l9_14=l9_13.x;
float l9_15=l9_13.y;
int l9_16;
#if (Tweak_N147HasSwappedViews)
{
...
#endif
vec4 l9_17=sc_SampleTextureBiasOrLevel(Tweak_N147Dims.xy,Tweak_N147Layout,l9_16,vec2((l9_15*l9_7)-(l9_14*l9_8),((l9_15*l9_8)+(l9_14*l9_7))+Tweak_N19),(int(SC_USE_UV_TRANSFORM_Tweak_N147)!=0),Tweak_N147Transform,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N147,SC_SOFTWARE_WRAP_MODE_V_Tweak_N147),(int(SC_USE_UV_MIN_MAX_Tweak_N147)!=0),Tweak_N147UvMinMax,(int(SC_USE_CLAMP_TO_BORDER_Tweak_N147)!=0),Tweak_N147BorderColor,0.0,Tweak_N147);
Default=vec4(mix(l9_6,(l9_6*Tweak_N17.xyz)*vec3(((l9_10.x+1.0)-Tweak_N13)*l9_17.x),vec3(Tweak_N17.w*Tweak_N13))+((Tweak_N18.xyz*vec3((l9_10.y*Tweak_N14)+l9_17.y))*vec3(Tweak_N18.w*Tweak_N14)),0.0);
Result=Default;
}
}
...
vec4 param_3;
Node278_If_else(0.0,vec4(0.0),vec4(0.0),param_3,ssGlobals(l9_1,l9_2,0.0,varPackedTex.xy,l9_3,l9_4.xyz));
