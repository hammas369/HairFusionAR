...
//sampler sampler colorTexSmpSC 2:18
...
//texture texture2D colorTex 2:1:2:18
...
#endif
vec4 l9_3=sc_SampleTextureBiasOrLevel(baseTexDims.xy,baseTexLayout,l9_2,l9_1,(int(SC_USE_UV_TRANSFORM_baseTex)!=0),baseTexTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex),(int(SC_USE_UV_MIN_MAX_baseTex)!=0),baseTexUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_baseTex)!=0),baseTexBorderColor,0.0,baseTex);
int l9_4;
...
{
if (Port_Value2_N017<((mod(dot(floor(mod(gl_FragCoord.xy,vec2(4.0))),vec2(4.0,1.0))*9.0,16.0)+1.0)/17.0))
{
discard;
}
}
...
{
l9_12=clamp(Port_Value2_N017*2.0,0.0,1.0);
}
#else
{
float l9_13;
...
{
l9_13=clamp(dot(l9_9.xyz,vec3(Port_Value2_N017)),0.0,1.0);
}
#else
{
float l9_14;
...
{
l9_15=(1.0-dot(l9_9.xyz,vec3(0.33333001)))*Port_Value2_N017;
}
#else
{
float l9_16;
...
{
l9_16=(1.0-clamp(dot(l9_9.xyz,vec3(1.0)),0.0,1.0))*Port_Value2_N017;
}
#else
{
float l9_17;
...
{
l9_17=clamp(dot(l9_9.xyz,vec3(1.0)),0.0,1.0)*Port_Value2_N017;
}
#else
{
float l9_18;
...
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_19=clamp(dot(l9_9.xyz,vec3(1.0)),0.0,1.0)*Port_Value2_N017;
}
#else
{
float l9_20;
...
{
l9_20=dot(l9_9.xyz,vec3(0.33333001))*Port_Value2_N017;
}
#else
{
float l9_21;
...
#endif
vec3 l9_33=mix(l9_31.xyz,definedBlend(l9_31.xyz,l9_9.xyz).xyz,vec3(Port_Value2_N017));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_35=vec4(mix(vec3(1.0),l9_9.xyz,vec3(Port_Value2_N017)),Port_Value2_N017);
}
#else
{
vec4 l9_36;
...
{
l9_37=clamp(Port_Value2_N017,0.0,1.0);
}
#else
{
l9_37=Port_Value2_N017;
}
#endif
...
#if (sc_OITDepthGatherPass)
{
vec2 l9_45=sc_ScreenCoordsGlobalToView(l9_0);
