...
vec3 l9_4=mix(l9_0,vec3(l9_3.xyz)*l9_0,vec3(Tweak_N39.w));
float l9_5=cos(Tweak_N20);
float l9_6=sin(Tweak_N20);
int l9_7;
...
#endif
vec4 l9_8=sc_SampleTextureBiasOrLevel(LitLookupDims.xy,LitLookupLayout,l9_7,vec2((Globals.VertexTangent_ViewSpace.y*l9_5)-(Globals.VertexTangent_ViewSpace.x*l9_6),((Globals.VertexTangent_ViewSpace.y*l9_6)+(Globals.VertexTangent_ViewSpace.x*l9_5))+Tweak_N19),(int(SC_USE_UV_TRANSFORM_LitLookup)!=0),LitLookupTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_LitLookup,SC_SOFTWARE_WRAP_MODE_V_LitLookup),(int(SC_USE_UV_MIN_MAX_LitLookup)!=0),LitLookupUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_LitLookup)!=0),LitLookupBorderColor,0.0,LitLookup);
Default=vec4(mix(l9_4,(l9_4*vec3(Tweak_N17.xyz))*vec3(l9_8.x),vec3(Tweak_N17.w*Tweak_N13))+((vec3(Tweak_N18.xyz)*vec3(l9_8.y))*vec3(Tweak_N18.w*Tweak_N14)),0.0);
Result=Default;
}
}
