...
uniform float Port_Import_N097;
uniform vec2 Port_Import_N098;
...
uniform vec2 Port_SpriteCount_N001;
uniform float Port_MaxFrames_N001;
uniform vec2 Port_Scale_N081;
uniform vec2 Port_Center_N081;
uniform float Port_Min_N050;
uniform float Port_Max_N050;
uniform vec2 Port_Center_N049;
uniform float Port_FrameOffset_N001;
uniform float Port_Min_N002;
uniform float Port_Max_N002;
uniform float Port_Min_N003;
uniform float Port_Max_N003;
...
gParticle=ssParticle(gParticle.Position,gParticle.Velocity,gParticle.Color,gParticle.Size,gParticle.Age,gParticle.Life,gParticle.Mass,gParticle.Matrix,false,gParticle.Quaternion,l9_7,fract(abs(((l9_6*0.97637898)+0.151235)+(floor(((((l9_8-l9_7)-0.0)+0.0)+10.0)/5.0)*4.32723))),(vec2(ivec2(l9_0%400,l9_0/400))+vec2(1.0))/vec2(399.0),float(((l9_0*((l9_0*1471343)+101146501))+1559861749)&2147483647)*4.6566129e-10,l9_0,l9_1,(l9_4+0.5)/10.0,l9_6,float(l9_1)/9.0,l9_3,(l9_5+vec2(0.5))/vec2(10.0,1.0),l9_5/vec2(9.0,1.0),vec3(0.0),false,float(l9_2));
int l9_9=InstanceID;
...
if (!l9_15)
{
l9_16=!vfxBatchEnable[sc_GetLocalInstanceID()/10];
}
else
{
l9_16=l9_15;
...
gParticle.Color.z=0.0+(((DecodeFloat32(sc_SampleTextureLevel(renderTarget3Dims.xy,renderTarget3Layout,renderTarget3GetStereoViewIndex(),l9_18,(int(SC_USE_UV_TRANSFORM_renderTarget3)!=0),renderTarget3Transform,ivec2(SC_SOFTWARE_WRAP_MODE_U_renderTarget3,SC_SOFTWARE_WRAP_MODE_V_renderTarget3),(int(SC_USE_UV_MIN_MAX_renderTarget3)!=0),renderTarget3UvMinMax,(int(SC_USE_CLAMP_TO_BORDER_renderTarget3)!=0),renderTarget3BorderColor,0.0,renderTarget3),true)-0.0)*(1.00001-0.0))/(0.99998999-0.0));
...
vec4 l9_21=sc_SampleTextureLevel(renderTarget3Dims.xy,renderTarget3Layout,renderTarget3GetStereoViewIndex(),l9_19,(int(SC_USE_UV_TRANSFORM_renderTarget3)!=0),renderTarget3Transform,ivec2(SC_SOFTWARE_WRAP_MODE_U_renderTarget3,SC_SOFTWARE_WRAP_MODE_V_renderTarget3),(int(SC_USE_UV_MIN_MAX_renderTarget3)!=0),renderTarget3UvMinMax,(int(SC_USE_CLAMP_TO_BORDER_renderTarget3)!=0),renderTarget3BorderColor,0.0,renderTarget3);
...
bool l9_3=l9_2>=(10*(vfxNumCopies+1));
bool l9_4;
if (!l9_3)
{
l9_4=vfxBatchEnable[sc_GetLocalInstanceID()/10]==false;
}
else
{
l9_4=l9_3;
...
vec3 l9_12;
if ((l9_11<0.029999999)||(Port_Import_N097<9.9999997e-05))
{
...
int l9_7=int(Interp_Particle_Index);
int l9_8=l9_7%10;
int l9_9=l9_7/10;
ivec2 l9_10=ivec2(l9_8,l9_9);
float l9_11=float(l9_7);
vec2 l9_12=vec2(l9_10);
float l9_13=l9_11/9.0;
float l9_14=float(((l9_7*((l9_7*1471343)+101146501))+1559861749)&2147483647)*4.6566129e-10;
float l9_15=l9_13*5.0;
float l9_16;
if (l9_4)
{
l9_16=overrideTimeElapsed;
}
else
{
l9_16=sc_Time.x;
}
ssParticle l9_17=ssParticle(Interp_Particle_Position,Interp_Particle_Velocity,Interp_Particle_Color,Interp_Particle_Size,Interp_Particle_Age,Interp_Particle_Life,Interp_Particle_Mass,mat3(0.0),false,Interp_Particle_Quaternion,l9_15,fract(abs(((l9_13*0.97637898)+0.151235)+(floor(((((l9_16-l9_15)-0.0)+0.0)+10.0)/5.0)*4.32723))),(vec2(ivec2(l9_7%400,l9_7/400))+vec2(1.0))/vec2(399.0),l9_14,l9_7,l9_8,(l9_11+0.5)/10.0,l9_13,float(l9_8)/9.0,l9_10,(l9_12+vec2(0.5))/vec2(10.0,1.0),l9_12/vec2(9.0,1.0),vec3(0.0),false,float(l9_9));
float l9_18=l9_14*l9_6;
float l9_19=l9_5-l9_18;
float l9_20=l9_19-0.0;
vec4 l9_21=ssGetParticleRandom(1,false,true,true,50.0,l9_17,0.0,l9_5);
float l9_22=radians(l9_20*mix(Port_Min_N050,Port_Max_N050,l9_21.x));
float l9_23=sin(l9_22);
float l9_24=cos(l9_22);
vec2 l9_25=(((varPackedTex.xy-Port_Center_N081)*Port_Scale_N081)+Port_Center_N081)-Port_Center_N049;
vec2 l9_26=vec2(dot(vec2(l9_24,l9_23),l9_25),dot(vec2(-l9_23,l9_24),l9_25))+Port_Center_N049;
vec4 l9_27=ssGetParticleRandom(1,false,true,true,2.0,l9_17,0.0,l9_5);
vec4 l9_28=ssGetParticleRandom(1,false,true,true,3.0,l9_17,0.0,l9_5);
float l9_29=floor(Port_SpriteCount_N001.x);
float l9_30=floor(Port_SpriteCount_N001.y);
float l9_31=1.0/l9_29;
float l9_32=1.0/l9_30;
float l9_33=floor(mod(((l9_20+mix(Port_Min_N003,Port_Max_N003,l9_28.x))*mix(Port_Min_N002,Port_Max_N002,l9_27.x))+floor(Port_FrameOffset_N001),min(l9_29*l9_30,floor(Port_MaxFrames_N001))));
int l9_34;
...
#endif
vec4 l9_35=sc_SampleTextureBiasOrLevel(baseTexDims.xy,baseTexLayout,l9_34,vec2((l9_31*l9_26.x)+(mod(l9_33,l9_29)*l9_31),((1.0-l9_32)-(floor(l9_33/l9_29)*l9_32))+(l9_32*l9_26.y)),(int(SC_USE_UV_TRANSFORM_baseTex)!=0),baseTexTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_baseTex,SC_SOFTWARE_WRAP_MODE_V_baseTex),(int(SC_USE_UV_MIN_MAX_baseTex)!=0),baseTexUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_baseTex)!=0),baseTexBorderColor,0.0,baseTex);
vec4 l9_36=Interp_Particle_Color*l9_35;
vec4 l9_37;
...
{
float l9_63=l9_36.w;
l9_62=vec4(mix(vec3(1.0),l9_36.xyz,vec3(l9_63)),l9_63);
}
#else
{
vec4 l9_64;
...
#endif
l9_64=vec4(l9_36.xyz*l9_66,l9_66);
}
#else
{
l9_64=l9_36;
