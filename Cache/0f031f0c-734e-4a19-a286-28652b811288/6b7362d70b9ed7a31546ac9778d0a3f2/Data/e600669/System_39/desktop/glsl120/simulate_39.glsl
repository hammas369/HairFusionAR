...
uniform float Port_Import_N175;
uniform vec2 Port_Import_N110;
...
uniform float Port_Min_N012;
uniform float Port_Max_N012;
...
uniform float Port_Input0_N234;
uniform float Port_Input1_N236;
uniform float Port_Input2_N236;
uniform float Port_Min_N017;
uniform float Port_Max_N017;
uniform float Port_Min_N004;
uniform float Port_Max_N004;
uniform float Port_Input2_N058;
uniform vec3 Port_Import_N066;
uniform float Port_Multiplier_N067;
uniform vec2 Port_Input1_N071;
uniform vec2 Port_Scale_N072;
uniform vec2 Port_Input1_N074;
uniform vec2 Port_Scale_N241;
uniform vec2 Port_Input1_N076;
uniform vec2 Port_Scale_N077;
uniform vec3 Port_Input1_N078;
...
uniform float Port_Import_N233;
uniform vec3 Port_Import_N247;
...
int l9_0=InstanceID%10;
int l9_1=InstanceID/10;
ivec2 l9_2=ivec2(l9_0,l9_1);
float l9_3=float(InstanceID);
vec2 l9_4=vec2(l9_2);
float l9_5=l9_3/9.0;
ssParticle l9_6=ssParticle(gParticle.Position,gParticle.Velocity,gParticle.Color,gParticle.Size,gParticle.Age,gParticle.Life,gParticle.Mass,gParticle.Matrix,false,gParticle.Quaternion,l9_5*5.0,0.0,gParticle.Seed2000,float(((InstanceID*((InstanceID*1471343)+101146501))+1559861749)&2147483647)*4.6566129e-10,InstanceID,l9_0,(l9_3+0.5)/10.0,l9_5,float(l9_0)/9.0,l9_2,(l9_4+vec2(0.5))/vec2(10.0,1.0),l9_4/vec2(9.0,1.0),vec3(0.0),false,float(l9_1));
...
if (!l9_13)
{
l9_14=!vfxBatchEnable[sc_GetLocalInstanceID()/10];
}
else
{
l9_14=l9_13;
...
gParticle.Color.w=0.0+(((DecodeFloat32(sc_SampleTextureLevel(renderTarget0Dims.xy,renderTarget0Layout,renderTarget0GetStereoViewIndex(),l9_17,(int(SC_USE_UV_TRANSFORM_renderTarget0)!=0),renderTarget0Transform,ivec2(SC_SOFTWARE_WRAP_MODE_U_renderTarget0,SC_SOFTWARE_WRAP_MODE_V_renderTarget0),(int(SC_USE_UV_MIN_MAX_renderTarget0)!=0),renderTarget0UvMinMax,(int(SC_USE_CLAMP_TO_BORDER_renderTarget0)!=0),renderTarget0BorderColor,0.0,renderTarget0),true)-0.0)*(1.00001-0.0))/(0.99998999-0.0));
gParticle.Mass=0.0+(((DecodeFloat32(sc_SampleTextureLevel(renderTarget1Dims.xy,renderTarget1Layout,renderTarget1GetStereoViewIndex(),l9_17,(int(SC_USE_UV_TRANSFORM_renderTarget1)!=0),renderTarget1Transform,ivec2(SC_SOFTWARE_WRAP_MODE_U_renderTarget1,SC_SOFTWARE_WRAP_MODE_V_renderTarget1),(int(SC_USE_UV_MIN_MAX_renderTarget1)!=0),renderTarget1UvMinMax,(int(SC_USE_CLAMP_TO_BORDER_renderTarget1)!=0),renderTarget1BorderColor,0.0,renderTarget1),true)-0.0)*(1000.0-0.0))/(0.99998999-0.0));
gParticle.Quaternion.x=(-1.0)+(((DecodeFloat16(vec2(l9_18.xy),true)-0.0)*(1.0-(-1.0)))/(0.99998999-0.0));
gParticle.Quaternion.y=(-1.0)+(((DecodeFloat16(vec2(l9_18.zw),true)-0.0)*(1.0-(-1.0)))/(0.99998999-0.0));
gParticle.Quaternion.z=(-1.0)+(((DecodeFloat16(vec2(l9_19.xy),true)-0.0)*(1.0-(-1.0)))/(0.99998999-0.0));
gParticle.Quaternion.w=(-1.0)+(((DecodeFloat16(vec2(l9_19.zw),true)-0.0)*(1.0-(-1.0)))/(0.99998999-0.0));
...
void Node112_Particle_Random(vec2 Min,vec2 Max,out vec2 Random,ssGlobals Globals)
{
Random=mix(Min,Max,ssGetParticleRandom(2,false,true,true,112.0,gParticle,0.0,Globals.gTimeElapsed).xy);
}
...
float l9_7=l9_6-0.0;
gParticle.Age=mod((l9_7-gParticle.SpawnOffset)+0.0,5.0);
...
if (!l9_14)
{
l9_15=mod(((l9_2-gParticle.SpawnOffset)-0.0)+0.0,5.0)<=l9_3;
}
else
{
l9_15=l9_14;
...
float l9_18=floor(sqrt(10.0*float(vfxNumCopies+1)));
int l9_19=int(l9_18);
...
gParticle.Matrix=mat3(vec3(1.0,0.0,0.0),vec3(0.0,1.0,0.0),vec3(0.0,0.0,1.0));
gParticle.Quaternion=vec4(0.0,0.0,0.0,1.0);
float l9_20=floor(clamp(Port_Import_N175,0.0,2.0));
vec3 l9_21;
if (l9_20==0.0)
{
vec2 l9_22;
Node112_Particle_Random(-Port_Import_N110,Port_Import_N110,l9_22,l9_16);
l9_21=vec3(l9_22,0.0);
}
else
{
vec3 l9_23;
...
{
vec2 l9_24;
Node112_Particle_Random(-Port_Import_N110,Port_Import_N110,l9_24,l9_16);
l9_23=vec3(l9_24.y,0.0,l9_24.x);
}
else
{
vec3 l9_25;
...
{
vec2 l9_26;
Node112_Particle_Random(-Port_Import_N110,Port_Import_N110,l9_26,l9_16);
l9_25=vec3(0.0,l9_26.yx);
}
else
{
vec2 l9_27;
Node112_Particle_Random(-Port_Import_N110,Port_Import_N110,l9_27,l9_16);
l9_25=vec3(l9_27,0.0);
}
l9_23=l9_25;
}
l9_21=l9_23;
}
gParticle.Position=Port_Import_N180+l9_21;
gParticle.Size=mix(Port_Import_N060,Port_Import_N062,ssGetParticleRandom(1,false,true,true,63.0,gParticle,0.0,l9_2).x);
gParticle.Mass=mix(Port_Import_N053,Port_Import_N054,ssGetParticleRandom(1,false,true,true,55.0,gParticle,0.0,l9_2).x);
gParticle.Mass=max(9.9999997e-06,gParticle.Mass);
gParticle.Color=mix(Port_Import_N010,Port_Import_N011,vec4(mix(Port_Min_N012,Port_Max_N012,ssGetParticleRandom(1,false,true,true,12.0,gParticle,0.0,l9_2).x)));
gParticle.Life=mix(Port_Import_N088,Port_Import_N089,ssGetParticleRandom(1,false,true,true,90.0,gParticle,0.0,l9_2).x);
...
gParticle.Position=(vfxModelMatrix[sc_GetLocalInstanceID()/10]*vec4(gParticle.Position,1.0)).xyz;
int l9_28=sc_GetLocalInstanceID()/10;
gParticle.Velocity=mat3(vfxModelMatrix[l9_28][0].xyz,vfxModelMatrix[l9_28][1].xyz,vfxModelMatrix[l9_28][2].xyz)*gParticle.Velocity;
int l9_29=sc_GetLocalInstanceID()/10;
gParticle.Force=mat3(vfxModelMatrix[l9_29][0].xyz,vfxModelMatrix[l9_29][1].xyz,vfxModelMatrix[l9_29][2].xyz)*gParticle.Force;
int l9_30=sc_GetLocalInstanceID()/10;
gParticle.Matrix=mat3(vfxModelMatrix[l9_30][0].xyz,vfxModelMatrix[l9_30][1].xyz,vfxModelMatrix[l9_30][2].xyz)*gParticle.Matrix;
gParticle.Size=max(length(vfxModelMatrix[sc_GetLocalInstanceID()/10][0].xyz),max(length(vfxModelMatrix[sc_GetLocalInstanceID()/10][1].xyz),length(vfxModelMatrix[sc_GetLocalInstanceID()/10][2].xyz)))*gParticle.Size;
...
float l9_31=clamp(gParticle.Age/gParticle.Life,0.0,1.0);
float l9_32=gParticle.Life+1.234e-06;
vec4 l9_33=vec4(gParticle.Color.x,gParticle.Color.y,gParticle.Color.z,vec4(0.0).w);
l9_33.w=mix(Port_Import_N026,Port_Import_N027,(clamp((l9_31*(Port_Input0_N030/((Port_Import_N185/l9_32)+1.234e-06)))+0.001,Port_Input1_N227+0.001,Port_Input2_N227+0.001)-0.001)*(clamp(((1.0-l9_31)*(Port_Input0_N234/((Port_Import_N188/l9_32)+1.234e-06)))+0.001,Port_Input1_N236+0.001,Port_Input2_N236+0.001)-0.001));
gParticle.Color=l9_33;
vec3 l9_34=((gParticle.Position*vec3(mix(Port_Min_N004,Port_Max_N004,ssGetParticleRandom(1,false,true,true,4.0,gParticle,0.0,l9_2).x)))*vec3(Port_Input2_N058))+(Port_Import_N066*vec3(l9_7*Port_Multiplier_N067));
vec2 l9_35=vec2(l9_34.xy)+Port_Input1_N071;
vec2 l9_36=vec2(l9_34.yz)+Port_Input1_N074;
vec2 l9_37=vec2(l9_34.zx)+Port_Input1_N076;
gParticle.Force+=(vec3(mix(Port_Min_N017,Port_Max_N017,ssGetParticleRandom(1,false,true,true,17.0,gParticle,0.0,l9_2).x))*((vec3(floor(((snoise(vec2(floor(l9_35.x*10000.0)*9.9999997e-05,floor(l9_35.y*10000.0)*9.9999997e-05)*(Port_Scale_N072*0.5))*0.5)+0.5)*10000.0)*9.9999997e-05,floor(((snoise(vec2(floor(l9_36.x*10000.0)*9.9999997e-05,floor(l9_36.y*10000.0)*9.9999997e-05)*(Port_Scale_N241*0.5))*0.5)+0.5)*10000.0)*9.9999997e-05,floor(((snoise(vec2(floor(l9_37.x*10000.0)*9.9999997e-05,floor(l9_37.y*10000.0)*9.9999997e-05)*(Port_Scale_N077*0.5))*0.5)+0.5)*10000.0)*9.9999997e-05)*Port_Input1_N078)-vec3(1.0)));
...
float l9_38=clamp(l9_3,9.9999997e-05,0.5);
float l9_39;
...
sc_SetClipPosition(vec4(((vec2(l9_47,l9_48)+(vec2(float(l9_46%512),float(l9_46/512))*l9_45))*2.0)-vec2(1.0),1.0,1.0));
...
{
l9_49=vec4((texture0*2.0)-vec2(1.0),1.0,1.0);
}
else
{
l9_49=vec4(0.0);
}
sc_SetClipPosition(l9_49);
