...
#endif
vec4 l9_2=baseColor*l9_0;
vec4 l9_3;
#if (Tweak_N6)
{
l9_3=Port_Input1_N008;
}
#else
{
int l9_4;
...
#endif
l9_3=sc_SampleTextureBiasOrLevel(opacityTexDims.xy,opacityTexLayout,l9_4,varPackedTex.xy,(int(SC_USE_UV_TRANSFORM_opacityTex)!=0),opacityTexTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_opacityTex,SC_SOFTWARE_WRAP_MODE_V_opacityTex),(int(SC_USE_UV_MIN_MAX_opacityTex)!=0),opacityTexUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_opacityTex)!=0),opacityTexBorderColor,0.0,opacityTex);
}
#endif
float l9_5=l9_2.w*l9_3.w;
...
vec4 l9_39=max(Port_FinalColor1_N004,vec4(0.0));
sc_writeFragData1(l9_39);
vec4 l9_40=outputMotionVectorsIfNeeded(varPos,max(l9_38,vec4(0.0))+(l9_39*1e-06));
