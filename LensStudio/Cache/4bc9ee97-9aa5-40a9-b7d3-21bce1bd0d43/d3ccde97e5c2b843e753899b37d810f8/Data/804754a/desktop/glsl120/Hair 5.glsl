...
float l9_1=Globals.Surface_UVCoord0.y-(1.0-Tweak_N152);
...
#endif
vec2 l9_13=((Globals.VertexTangent_ViewSpace.xy+((Port_Value_N116+vec2(0.001))-vec2(0.001)))-((sc_SampleTextureBiasOrLevel(Tweak_N180Dims.xy,Tweak_N180Layout,l9_12,l9_2,(int(SC_USE_UV_TRANSFORM_Tweak_N180)!=0),Tweak_N180Transform,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N180,SC_SOFTWARE_WRAP_MODE_V_Tweak_N180),(int(SC_USE_UV_MIN_MAX_Tweak_N180)!=0),Tweak_N180UvMinMax,(int(SC_USE_CLAMP_TO_BORDER_Tweak_N180)!=0),Tweak_N180BorderColor,0.0,Tweak_N180).xy*Port_Input1_N085)-vec2(1.0)))*Port_Input1_N121;
float l9_14=l9_13.x;
float l9_15=l9_13.y;
vec4 l9_16=sc_SampleTextureBiasOrLevel(LitLookupDims.xy,LitLookupLayout,LitLookupGetStereoViewIndex(),vec2((l9_15*l9_9)-(l9_14*l9_10),((l9_15*l9_10)+(l9_14*l9_9))+Tweak_N19),(int(SC_USE_UV_TRANSFORM_LitLookup)!=0),LitLookupTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_LitLookup,SC_SOFTWARE_WRAP_MODE_V_LitLookup),(int(SC_USE_UV_MIN_MAX_LitLookup)!=0),LitLookupUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_LitLookup)!=0),LitLookupBorderColor,0.0,LitLookup);
int l9_17;
...
#endif
vec4 l9_18=sc_SampleTextureBiasOrLevel(Tweak_N3Dims.xy,Tweak_N3Layout,l9_17,Globals.Surface_UVCoord0,(int(SC_USE_UV_TRANSFORM_Tweak_N3)!=0),Tweak_N3Transform,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N3,SC_SOFTWARE_WRAP_MODE_V_Tweak_N3),(int(SC_USE_UV_MIN_MAX_Tweak_N3)!=0),Tweak_N3UvMinMax,(int(SC_USE_CLAMP_TO_BORDER_Tweak_N3)!=0),Tweak_N3BorderColor,0.0,Tweak_N3);
Default=vec4(mix(l9_8,(l9_8*vec3(Tweak_N17.xyz))*vec3(((l9_11.x+1.0)-Tweak_N13)*l9_16.x),vec3(Tweak_N17.w*l9_18.x))+((vec3(Tweak_N18.xyz)*vec3((l9_11.y*Tweak_N14)+l9_16.y))*vec3(Tweak_N18.w*l9_18.y)),0.0);
Result=Default;
}
}
