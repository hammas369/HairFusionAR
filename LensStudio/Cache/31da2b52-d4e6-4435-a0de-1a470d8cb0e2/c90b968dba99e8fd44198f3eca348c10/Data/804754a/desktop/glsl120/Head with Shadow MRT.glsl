...
uniform float Port_RangeMaxB_N009;
...
#endif
float l9_0=varPackedTex.w+(Tweak_N6*Port_Input1_N007);
float l9_1;
if (l9_0<=0.0)
{
l9_1=0.0;
...
{
l9_1=pow(l9_0,(((Tweak_N8-Port_RangeMinA_N009)/(Port_RangeMaxA_N009-Port_RangeMinA_N009))*(Port_RangeMaxB_N009-Port_RangeMinB_N009))+Port_RangeMinB_N009);
}
float l9_2=l9_1+0.001;
vec4 l9_3=baseColor*vec4(clamp(l9_2,Port_Input1_N005+0.001,Port_Input2_N005+0.001)-0.001);
float l9_4=l9_3.w;
...
vec4 l9_37=max(Port_FinalColor1_N004,vec4(0.0));
sc_writeFragData1(l9_37);
vec4 l9_38=outputMotionVectorsIfNeeded(varPos,max(l9_36,vec4(0.0))+(l9_37*1e-06));
