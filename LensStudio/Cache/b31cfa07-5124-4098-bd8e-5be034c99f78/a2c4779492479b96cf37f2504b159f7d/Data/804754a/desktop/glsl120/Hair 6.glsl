...
//sampler sampler Tweak_N180SmpSC 2:21
...
//texture texture2D Tweak_N180 2:2:2:21
//texture texture2D Tweak_N3 2:3:2:22
...
uniform float Port_Import_N261;
uniform float Port_Import_N263;
uniform vec3 Port_Import_N237;
uniform vec2 Port_Value_N178;
uniform vec4 Port_Import_N236;
uniform vec4 Port_Input1_N181;
uniform vec2 Port_Input1_N184;
uniform vec2 Port_Import_N188;
uniform float Port_Import_N238;
uniform float Port_Import_N190;
uniform float Port_Import_N239;
uniform float Port_Import_N199;
uniform vec2 Port_Import_N260;
uniform float Port_Import_N157;
uniform float Port_Import_N159;
uniform vec4 Port_Import_N044;
uniform vec3 Port_Import_N161;
uniform float Port_Import_N265;
uniform float Port_Import_N266;
uniform vec2 Port_Input1_N207;
uniform vec2 Port_Import_N211;
uniform float Port_Import_N213;
uniform float Port_Import_N222;
uniform vec2 Port_Import_N262;
...
int LitLookupGetStereoViewIndex()
{
int l9_0;
...
{
Bool1=float(varDebugColor.w>Port_Input1_N046);
if ((Bool1*1.0)!=0.0)
{
...
float l9_1=(Globals.Surface_UVCoord0.y*Tweak_N8)-((1.0-Tweak_N12)+(Tweak_N11*(floor(fract(sin(floor(floor((floor(varStrandId65535*10000.0)*9.9999997e-05)*Port_Scale_N028)*10000.0)*9.9999997e-05)*437.58499)*10000.0)*9.9999997e-05)));
vec2 l9_2=vec2(Globals.Surface_UVCoord0.x,l9_1);
int l9_3;
...
#endif
vec4 l9_4=sc_SampleTextureBiasOrLevel(Tweak_N0Dims.xy,Tweak_N0Layout,l9_3,l9_2,(int(SC_USE_UV_TRANSFORM_Tweak_N0)!=0),Tweak_N0Transform,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N0,SC_SOFTWARE_WRAP_MODE_V_Tweak_N0),(int(SC_USE_UV_MIN_MAX_Tweak_N0)!=0),Tweak_N0UvMinMax,(int(SC_USE_CLAMP_TO_BORDER_Tweak_N0)!=0),Tweak_N0BorderColor,0.0,Tweak_N0);
if (l9_4.w<Tweak_N9)
{
discard;
}
...
vec3 l9_5=vec3(l9_4.xyz);
vec3 l9_6=vec3(Tweak_N5.xyz);
float l9_7=Tweak_N16*Port_Input1_N057;
vec3 l9_8=mix(mix(l9_0,l9_5*l9_0,vec3(Tweak_N6.w)),mix(l9_6,l9_5*l9_6,vec3(Tweak_N5.w)),vec3(smoothstep(Tweak_N15-l9_7,Tweak_N15+l9_7,Globals.Surface_UVCoord0.y)));
float l9_9=cos(Tweak_N20);
float l9_10=sin(Tweak_N20);
vec4 l9_11=sc_SampleTextureBiasOrLevel(LitLookupDims.xy,LitLookupLayout,LitLookupGetStereoViewIndex(),vec2((Globals.VertexTangent_ViewSpace.y*l9_9)-(Globals.VertexTangent_ViewSpace.x*l9_10),((Globals.VertexTangent_ViewSpace.y*l9_10)+(Globals.VertexTangent_ViewSpace.x*l9_9))+Tweak_N19),(int(SC_USE_UV_TRANSFORM_LitLookup)!=0),LitLookupTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_LitLookup,SC_SOFTWARE_WRAP_MODE_V_LitLookup),(int(SC_USE_UV_MIN_MAX_LitLookup)!=0),LitLookupUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_LitLookup)!=0),LitLookupBorderColor,0.0,LitLookup);
vec2 l9_12=Globals.VertexTangent_ViewSpace.xy+((Port_Value_N178+vec2(0.001))-vec2(0.001));
int l9_13;
...
#endif
vec4 l9_14=sc_SampleTextureBiasOrLevel(Tweak_N180Dims.xy,Tweak_N180Layout,l9_13,l9_2,(int(SC_USE_UV_TRANSFORM_Tweak_N180)!=0),Tweak_N180Transform,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N180,SC_SOFTWARE_WRAP_MODE_V_Tweak_N180),(int(SC_USE_UV_MIN_MAX_Tweak_N180)!=0),Tweak_N180UvMinMax,(int(SC_USE_CLAMP_TO_BORDER_Tweak_N180)!=0),Tweak_N180BorderColor,0.0,Tweak_N180);
vec4 l9_15=(l9_14*Port_Input1_N181)-vec4(1.0);
vec2 l9_16=(l9_12-vec2(l9_15.xy))*Port_Input1_N184;
float l9_17=l9_16.x;
float l9_18=l9_16.y;
vec4 l9_19=sc_SampleTextureBiasOrLevel(LitLookupDims.xy,LitLookupLayout,LitLookupGetStereoViewIndex(),vec2((l9_18*l9_9)-(l9_17*l9_10),((l9_18*l9_10)+(l9_17*l9_9))+Tweak_N19),(int(SC_USE_UV_TRANSFORM_LitLookup)!=0),LitLookupTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_LitLookup,SC_SOFTWARE_WRAP_MODE_V_LitLookup),(int(SC_USE_UV_MIN_MAX_LitLookup)!=0),LitLookupUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_LitLookup)!=0),LitLookupBorderColor,0.0,LitLookup);
int l9_20;
...
#endif
vec4 l9_21=sc_SampleTextureBiasOrLevel(Tweak_N3Dims.xy,Tweak_N3Layout,l9_20,Globals.Surface_UVCoord0,(int(SC_USE_UV_TRANSFORM_Tweak_N3)!=0),Tweak_N3Transform,ivec2(SC_SOFTWARE_WRAP_MODE_U_Tweak_N3,SC_SOFTWARE_WRAP_MODE_V_Tweak_N3),(int(SC_USE_UV_MIN_MAX_Tweak_N3)!=0),Tweak_N3UvMinMax,(int(SC_USE_CLAMP_TO_BORDER_Tweak_N3)!=0),Tweak_N3BorderColor,0.0,Tweak_N3);
vec2 l9_22=(l9_12-vec2(l9_15.zw))*Port_Input1_N207;
float l9_23=l9_22.x;
float l9_24=l9_22.y;
Default=vec4(mix(l9_8,(l9_8*vec3(Tweak_N17.xyz))*vec3(((l9_11.x+1.0)-Tweak_N13)*l9_19.x),vec3(Tweak_N17.w*l9_21.x))+((vec3(Tweak_N18.xyz)*vec3((l9_11.y*Tweak_N14)+sc_SampleTextureBiasOrLevel(LitLookupDims.xy,LitLookupLayout,LitLookupGetStereoViewIndex(),vec2((l9_24*l9_9)-(l9_23*l9_10),((l9_24*l9_10)+(l9_23*l9_9))+Tweak_N19),(int(SC_USE_UV_TRANSFORM_LitLookup)!=0),LitLookupTransform,ivec2(SC_SOFTWARE_WRAP_MODE_U_LitLookup,SC_SOFTWARE_WRAP_MODE_V_LitLookup),(int(SC_USE_UV_MIN_MAX_LitLookup)!=0),LitLookupUvMinMax,(int(SC_USE_CLAMP_TO_BORDER_LitLookup)!=0),LitLookupBorderColor,0.0,LitLookup).y))*vec3(Tweak_N18.w*l9_21.y)),0.0);
Result=Default;
}
}
...
vec4 param_3;
Node47_If_else(0.0,vec4(0.0),vec4(0.0),param_3,ssGlobals(l9_1,l9_2,0.0,varPackedTex.xy,l9_3,l9_4.xyz));
